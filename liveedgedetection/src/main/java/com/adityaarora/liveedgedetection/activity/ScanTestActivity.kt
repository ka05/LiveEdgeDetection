 ...
 */
class ScanTestActivity : AppCompatActivity(), IScanner, View.OnClickListener, PermissionsDelegate {
    ...
    companion object {
        private val TAG = ScanTestActivity::class.java.simpleName
    ...
    private fun loadCameraView() {
        mImageSurfaceView = ScanSurfaceView(this@ScanTestActivity, this)
